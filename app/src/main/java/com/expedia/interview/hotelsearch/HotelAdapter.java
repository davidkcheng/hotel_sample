package com.expedia.interview.hotelsearch;
...
import com.expedia.interview.hotelsearch.data.Hotel;
import com.expedia.interview.hotelsearch.util.DataUtil;
import com.expedia.interview.hotelsearch.util.FontManager;
...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.HotelViewHolder> {
    ...
    public HotelViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(context).inflate(R.layout.hotel_list_item, parent, false);
